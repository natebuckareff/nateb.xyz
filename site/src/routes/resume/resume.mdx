...
I specialize in helping people translate business needs into technical solutions while staying focused on the customer. This alows me to bridge between highly technical teams, design, and project stakeholders. I am looking for roles that allow me to help organizations streamline product development by maximizing developer productivity (by optimizing the DX), designing human and machine automation processes, and fearlessly tackling deep technical problems.
...
<div class="flex flex-wrap items-start justify-center gap-4 print:gap-0 mt-4">
    <SkillBubble>Docker</SkillBubble>
    <SkillBubble>Git</SkillBubble>
    <SkillBubble>Go</SkillBubble>
    <SkillBubble>Rust</SkillBubble>
    <SkillBubble>C</SkillBubble>
    <SkillBubble>DevOps</SkillBubble>
    <SkillBubble>Heroku</SkillBubble>
    <SkillBubble>WebAssembly</SkillBubble>
    <SkillBubble>Lua</SkillBubble>
    <SkillBubble>Mindfulness</SkillBubble>
    <SkillBubble>Nix</SkillBubble>
    <SkillBubble>NixOS</SkillBubble>
    <SkillBubble>HTTP/1</SkillBubble>
    <SkillBubble>Ubuntu</SkillBubble>
    <SkillBubble>Alpine Linux</SkillBubble>
    <SkillBubble>GraphViz</SkillBubble>
    ...
    <SkillBubble>Dudeism</SkillBubble>
    <SkillBubble>Technical writing</SkillBubble>
    <SkillBubble>Emacs</SkillBubble>
...
<div class="hidden print:block break-before-page mb-8 text-lg">
    <h3>Contact</h3>
    <ul>
        <li>
